...
import com.repzone.sync.service.bulk.ProductGroupRawSqlBulkInsertService
...
val SyncModule = module {
    ...
    single<IBulkInsertService<List<ServiceProductGroupDto>>>(named("productGroupBulkInsert")) { ProductGroupRawSqlBulkInsertService(get(), get()) }
