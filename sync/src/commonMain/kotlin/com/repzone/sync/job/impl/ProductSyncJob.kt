...
class ProductSyncJob(apiService: ISyncApiService<List<MobileProductDto>>, bulkInsertService: IBulkInsertService<List<MobileProductDto>>, syncModuleRepository: ISyncModuleRepository)
    : BasePaginatedSyncJob<List<MobileProductDto>>(apiService, bulkInsertService, syncModuleRepository) {
