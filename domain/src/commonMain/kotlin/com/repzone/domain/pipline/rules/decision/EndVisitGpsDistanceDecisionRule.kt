...
class EndVisitGpsDistanceDecisionRule(
    ...
    override val id: RuleId = RuleId.END_VISIT_GPS_DISTANCE_CHECK
    override val title: UiText = UiText.resource(StringResource.WARNING)
    var has_Active_Visit = false
    var active_visit_id = 0L
    //endregion
    ...
    override suspend fun canExecute(context: PipelineContext): Boolean {
        has_Active_Visit = context.getData<Boolean>("has_active_visit") ?: false
        active_visit_id = context.getData<Long>("active_visit_id") ?: 0L
        return has_Active_Visit && active_visit_id != 0L
    }
