...
enum class ErrorCode(val code: StringResource) {
    ...
    ERROR_INVALID_PROMOTION_SLOT(StringResource.ERROR_INVALID_PROMOTION_SLOT),
    ERROR_INVALID_PROMOTION_SLOT_MANUEL(StringResource.ERROR_INVALID_PROMOTION_SLOT_MANUEL),
    ERROR_INVALID_PROMOTION_SLOT_MANUEL_MAXIMUM(StringResource.ERROR_INVALID_PROMOTION_SLOT_MAXIMUM_PERCENTAGE),
    ERROR_LINE_NOT_FOUND(StringResource.ERROR_LINE_NOT_FOUND)
}
